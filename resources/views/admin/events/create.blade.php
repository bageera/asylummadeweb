      ...
      <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
          <div class="card-body p-4">
            <h1 class="h4 fw-bold mb-4">Add New Event</h1>
            ...
            <form action="{{ route('admin.events.store') }}" method="POST">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="time" id="gates_open_time" name="gates_open_time" class="form-control" value="{{ old('gates_open_time') }}">
                </div>

                <div class="col-md-4">
                  <label for="practice_start_time" class="form-label">Practice Start</label>
                  <input type="time" id="practice_start_time" name="practice_start_time" class="form-control" value="{{ old('practice_start_time') }}">
                </div>

                <div class="col-md-4">
                  <label for="racing_start_time" class="form-label">Racing Start</label>
                  <input type="time" id="racing_start_time" name="racing_start_time" class="form-control" value="{{ old('racing_start_time') }}">
                </div>

                <div class="col-md-4">
                  <label for="admission_general" class="form-label">General Admission ($)</label>
                  <input type="number" step="0.01" id="admission_general" name="admission_general" class="form-control" value="{{ old('admission_general') }}">
                </div>

                <div class="col-md-4">
                  <label for="admission_pit" class="form-label">Pit Pass ($)</label>
                  <input type="number" step="0.01" id="admission_pit" name="admission_pit" class="form-control" value="{{ old('admission_pit') }}">
                </div>

                <div class="col-md-4">
                  <label for="admission_kids" class="form-label">Kids Admission ($)</label>
                  <input type="number" step="0.01" id="admission_kids" name="admission_kids" class="form-control" value="{{ old('admission_kids') }}">
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                      <div class="form-check">
                        <input type="checkbox" id="class_{{ $class->id }}" name="vehicle_classes[]" value="{{ $class->id }}" class="form-check-input" {{ in_array($class->id, old('vehicle_classes', [])) ? 'checked' : '' }}>
                ...
                <div class="col-12">
                  ...
                  <input type="text" id="track_condition" name="track_condition" class="form-control" value="{{ old('track_condition') }}" placeholder="e.g., Clay, Dry">
                </div>

                <div class="col-12">
                  <label for="special_notes" class="form-label">Special Notes</label>
                  <textarea id="special_notes" name="special_notes" class="form-control" rows="3">{{ old('special_notes') }}</textarea>
                </div>
              </div>
